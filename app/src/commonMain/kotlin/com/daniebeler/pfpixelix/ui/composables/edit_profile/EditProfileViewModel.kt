...
//    var avatarUri by mutableStateOf<Uri>(Uri.EMPTY) todo
...
//                    avatarUri = accountState.account?.avatar!!.toUri() todo
    ...
    fun save(context: KmpContext) {
        //todo
//        val newAvatarUri: KmpUri? = if (avatarUri == accountState.account?.avatar?.toUri()) {
//            null
//        } else {
//            avatarUri
//        }
